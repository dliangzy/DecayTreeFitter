...
#cmt_local_tagfile = $(DecayTreeFitterSvc_tag).make
cmt_local_tagfile = $(bin)$(DecayTreeFitterSvc_tag).make
...
cmt_local_setup_DecayTreeFitterSvc = $(bin)setup_DecayTreeFitterSvc$$$$.make
...
DecayTreeFitterSvc_extratags = -tag_add=target_DecayTreeFitterSvc

#$(cmt_local_tagfile_DecayTreeFitterSvc) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_DecayTreeFitterSvc) ::
else
$(cmt_local_tagfile_DecayTreeFitterSvc) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_DecayTreeFitterSvc); then /bin/rm -f $(cmt_local_tagfile_DecayTreeFitterSvc); fi ; \
	  $(cmtexe) -tag=$(tags) $(DecayTreeFitterSvc_extratags) build tag_makefile >>$(cmt_local_tagfile_DecayTreeFitterSvc)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_DecayTreeFitterSvc)"; \
	  test ! -f $(cmt_local_setup_DecayTreeFitterSvc) || \rm -f $(cmt_local_setup_DecayTreeFitterSvc); \
	  trap '\rm -f $(cmt_local_setup_DecayTreeFitterSvc)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(DecayTreeFitterSvc_extratags) show setup >$(cmt_local_setup_DecayTreeFitterSvc) && \
	  if [ -f $(cmt_final_setup_DecayTreeFitterSvc) ] && \
	    \cmp -s $(cmt_final_setup_DecayTreeFitterSvc) $(cmt_local_setup_DecayTreeFitterSvc); then \
	    \rm $(cmt_local_setup_DecayTreeFitterSvc); else \
	    \mv -f $(cmt_local_setup_DecayTreeFitterSvc) $(cmt_final_setup_DecayTreeFitterSvc); fi
...
not_DecayTreeFitterSvc_dependencies = { n=0; for p in $?; do m=0; for d in $(DecayTreeFitterSvc_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
DecayTreeFitterSvcdirs :
	@if test ! -d $(bin)DecayTreeFitterSvc; then $(mkdir) -p $(bin)DecayTreeFitterSvc; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)DecayTreeFitterSvc
else
DecayTreeFitterSvcdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)DecayTreeFitterSvc
#
#$(cmt_local_DecayTreeFitterSvc_makefile) :: $(DecayTreeFitterSvc_dependencies) $(cmt_local_tagfile_DecayTreeFitterSvc) build_library_links dirs DecayTreeFitterSvcdirs
#else
#$(cmt_local_DecayTreeFitterSvc_makefile) :: $(DecayTreeFitterSvc_dependencies) $(cmt_local_tagfile_DecayTreeFitterSvc) build_library_links dirs
#endif
#else
#$(cmt_local_DecayTreeFitterSvc_makefile) :: $(cmt_local_tagfile_DecayTreeFitterSvc)
#endif

ifdef cmt_DecayTreeFitterSvc_has_target_tag

ifndef QUICK
$(cmt_local_DecayTreeFitterSvc_makefile) : $(DecayTreeFitterSvc_dependencies) build_library_links
	$(echo) "(constituents.make) Building DecayTreeFitterSvc.make"; \
	  $(cmtexe) -tag=$(tags) $(DecayTreeFitterSvc_extratags) build constituent_config -out=$(cmt_local_DecayTreeFitterSvc_makefile) DecayTreeFitterSvc
else
$(cmt_local_DecayTreeFitterSvc_makefile) : $(DecayTreeFitterSvc_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_DecayTreeFitterSvc) ] || \
	  [ ! -f $(cmt_final_setup_DecayTreeFitterSvc) ] || \
	  $(not_DecayTreeFitterSvc_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building DecayTreeFitterSvc.make"; \
	  $(cmtexe) -tag=$(tags) $(DecayTreeFitterSvc_extratags) build constituent_config -out=$(cmt_local_DecayTreeFitterSvc_makefile) DecayTreeFitterSvc; \
	  fi
endif
...
$(cmt_local_DecayTreeFitterSvc_makefile) : $(DecayTreeFitterSvc_dependencies) build_library_links
	$(echo) "(constituents.make) Building DecayTreeFitterSvc.make"; \
	  $(cmtexe) -f=$(bin)DecayTreeFitterSvc.in -tag=$(tags) $(DecayTreeFitterSvc_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_DecayTreeFitterSvc_makefile) DecayTreeFitterSvc
else
$(cmt_local_DecayTreeFitterSvc_makefile) : $(DecayTreeFitterSvc_dependencies) $(cmt_build_library_linksstamp) $(bin)DecayTreeFitterSvc.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_DecayTreeFitterSvc) ] || \
	  [ ! -f $(cmt_final_setup_DecayTreeFitterSvc) ] || \
	  $(not_DecayTreeFitterSvc_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(DecayTreeFitterSvc_extratags) build constituent_makefile -out=$(cmt_local_DecayTreeFitterSvc_makefile) DecayTreeFitterSvc

DecayTreeFitterSvc :: $(DecayTreeFitterSvc_dependencies) $(cmt_local_DecayTreeFitterSvc_makefile) dirs DecayTreeFitterSvcdirs
	$(echo) "(constituents.make) Starting DecayTreeFitterSvc"
	@if test -f $(cmt_local_DecayTreeFitterSvc_makefile); then \
	  $(MAKE) -f $(cmt_local_DecayTreeFitterSvc_makefile) DecayTreeFitterSvc; \
	  fi
#	@$(MAKE) -f $(cmt_local_DecayTreeFitterSvc_makefile) DecayTreeFitterSvc
	$(echo) "(constituents.make) DecayTreeFitterSvc done"

clean :: DecayTreeFitterSvcclean

DecayTreeFitterSvcclean :: $(DecayTreeFitterSvcclean_dependencies) ##$(cmt_local_DecayTreeFitterSvc_makefile)
	$(echo) "(constituents.make) Starting DecayTreeFitterSvcclean"
	@-if test -f $(cmt_local_DecayTreeFitterSvc_makefile); then \
	  $(MAKE) -f $(cmt_local_DecayTreeFitterSvc_makefile) DecayTreeFitterSvcclean; \
	fi
	$(echo) "(constituents.make) DecayTreeFitterSvcclean done"
#	@-$(MAKE) -f $(cmt_local_DecayTreeFitterSvc_makefile) DecayTreeFitterSvcclean

##	  /bin/rm -f $(cmt_local_DecayTreeFitterSvc_makefile) $(bin)DecayTreeFitterSvc_dependencies.make

install :: DecayTreeFitterSvcinstall

DecayTreeFitterSvcinstall :: $(DecayTreeFitterSvc_dependencies) $(cmt_local_DecayTreeFitterSvc_makefile)
	$(echo) "(constituents.make) Starting install DecayTreeFitterSvc"
	@-$(MAKE) -f $(cmt_local_DecayTreeFitterSvc_makefile) install
	$(echo) "(constituents.make) install DecayTreeFitterSvc done"

uninstall : DecayTreeFitterSvcuninstall

$(foreach d,$(DecayTreeFitterSvc_dependencies),$(eval $(d)uninstall_dependencies += DecayTreeFitterSvcuninstall))

DecayTreeFitterSvcuninstall : $(DecayTreeFitterSvcuninstall_dependencies) ##$(cmt_local_DecayTreeFitterSvc_makefile)
	$(echo) "(constituents.make) Starting uninstall DecayTreeFitterSvc"
	@if test -f $(cmt_local_DecayTreeFitterSvc_makefile); then \
	  $(MAKE) -f $(cmt_local_DecayTreeFitterSvc_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_DecayTreeFitterSvc_makefile) uninstall
	$(echo) "(constituents.make) uninstall DecayTreeFitterSvc done"

remove_library_links :: DecayTreeFitterSvcuninstall
...
#cmt_local_tagfile_install_includes = $(DecayTreeFitterSvc_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(DecayTreeFitterSvc_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)DecayTreeFitterSvc_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(DecayTreeFitterSvc_tag).make
cmt_local_tagfile_install_includes = $(bin)$(DecayTreeFitterSvc_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)DecayTreeFitterSvcsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(DecayTreeFitterSvc_tag)_make.make
cmt_local_tagfile_make = $(bin)$(DecayTreeFitterSvc_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)DecayTreeFitterSvc_makesetup.make
...
#cmt_local_tagfile_make = $(DecayTreeFitterSvc_tag).make
cmt_local_tagfile_make = $(bin)$(DecayTreeFitterSvc_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)DecayTreeFitterSvcsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(DecayTreeFitterSvc_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(DecayTreeFitterSvc_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)DecayTreeFitterSvc_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(DecayTreeFitterSvc_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(DecayTreeFitterSvc_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)DecayTreeFitterSvcsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(DecayTreeFitterSvc_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(DecayTreeFitterSvc_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)DecayTreeFitterSvc_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(DecayTreeFitterSvc_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(DecayTreeFitterSvc_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)DecayTreeFitterSvcsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(DecayTreeFitterSvc_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(DecayTreeFitterSvc_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)DecayTreeFitterSvc_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(DecayTreeFitterSvc_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(DecayTreeFitterSvc_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)DecayTreeFitterSvcsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(DecayTreeFitterSvc_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(DecayTreeFitterSvc_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)DecayTreeFitterSvc_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(DecayTreeFitterSvc_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(DecayTreeFitterSvc_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)DecayTreeFitterSvcsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(DecayTreeFitterSvc_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(DecayTreeFitterSvc_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)DecayTreeFitterSvc_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(DecayTreeFitterSvc_tag).make
cmt_local_tagfile_TestProject = $(bin)$(DecayTreeFitterSvc_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)DecayTreeFitterSvcsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(DecayTreeFitterSvc_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(DecayTreeFitterSvc_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)DecayTreeFitterSvc_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(DecayTreeFitterSvc_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(DecayTreeFitterSvc_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)DecayTreeFitterSvcsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(DecayTreeFitterSvc_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(DecayTreeFitterSvc_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)DecayTreeFitterSvc_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(DecayTreeFitterSvc_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(DecayTreeFitterSvc_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)DecayTreeFitterSvcsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
